...
For a couple years, [[quasi-institutions/aaaarg-org|AAAARG.ORG]] hosted an open-mic radio station on its front page called Very Public Radio, inspired by the little stories that I had read about [Radio Alice](https://en.wikipedia.org/wiki/Radio_Alice). The way it worked was that if no one was broadcasting, everyone would see a broadcast button, and anyone could broadcast live from their computer. Once they stopped, the recording was archived. When no one was broadcasting, recordings from the archive were randomly selected for playback until they were interrupted by a live transmission. 
...
- _Open Scores: How to Program the Commons._ panke.gallery, Berlin, DE, 2019